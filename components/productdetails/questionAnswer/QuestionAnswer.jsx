            ...
            <div>
...

                {
                    comments.map((comment, index) => {
                        return <div className="flex justify-between items-start gap-4  mt-4 " >
...

                                    {
                                        ...
                                        comment.response?.map((res, index1) => {
                                            ...
                                            return <div className="flex gap-4 w-full items-center">
                                                ...
                                                <div key={index1} className="border border-dotted  py-4 px-2 rounded-lg border-gray-500 w-full">
                ...
                {
                    userLoginned && (
                        <FormSection title="پرسش و پاسخ" placeholdertext="متن پرسش خود را وارد کنید ..." buttonText="ثبت پرسش" isComment={false}/>
