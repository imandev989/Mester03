  ...
  return (
    <div className="bg-gray-100 rounded-md shadow-lg p-4">
      <div className="flex flex-col gap-2 divide-y-2 justify-between w-full">
        <div className="flex flex-col gap-2 lg:flex-row  lg:justify-between items-center w-full">
          <div className="lg:w-1/2 text-orange-500 text-xl">
            {informations.productName}
          </div>
          <div className="w-1/2 flex justify-center items-center gap-4 text-gray-500">
            <div
        ...
        <div
          className={
            "flex flex-col gap-2 lg:flex-row lg:justify-between lg:items-center pt-4 w-full"
          }
          style={{
        ...
        >
          <div className=" flex justify-start items-center gap-4">
            ...
            <span className="text-gray-400 text-sm lg:text-md">
              {informations.fullLocation}
            </span>
          </div>
          <div className={`flex justify-center py-8 lg:py-0 lg:justify-end`}>
            <span
              className="bg-rose-700 text-white px-8 py-2 rounded-full text-sm cursor-pointer"
