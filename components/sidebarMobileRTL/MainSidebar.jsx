...
const MainSidebar = () => {
  ...
  return (
    ...
    <div
    className={`lg:hidden overflow-auto top-0 right-0 w-[60vw] bg-white  p-1  text-white fixed h-full z-40 ease-in-out duration-300 ${
      ...
      <div className="mt-5 text-xl  w-full "><MainSidebarContetnt/></div>
    </div>
  </div>
  );
};
