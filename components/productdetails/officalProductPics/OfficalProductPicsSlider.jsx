...
const OfficalProductPicsSlider = () => {
    ...
    const thumbsImages1 = [p1, p2, p3, p4, p5, p6, p1, p2, p3, p4, p5, p6, p1, p2, p3, p4, p5, p6, p1, p2, p3, p4, p5, p6];
    ...
    return (
        <div className="flex flex-col lg:flex-row lg:justify-between lg:items-start lg:gap-4 lg:p-4 h-[100%] w-[100%]">
            <div
                style={generalStyle}
                className="w-full lg:w-[60%]  h-[100%] lg:rounded-lg lg:overflow-hidden"
            >
                            ...
                            (thumbnail.type === 'video') ? (
                                    <SplideSlide key={index}>
                                        ...
                                        <ReactPlayer
                                            ...
                                            width="100%"
                                            height="100%"
                                            light={<Image src={thumbnail.picsrc} alt='Thumbnail' />}
            ...
            <div className="hidden lg:flex lg:flex-col lg:gap-4 lg:justify-between  w-[40%] h-[100%]">
                                    ...
                                    (thumbnail.type === 'video') ? (
                                        <div className="relative" onClick={() => handleThumbs(index)}>
                                            ...
                                            <div className="hover:opacity-25" >
                                                <div className="absolute top-0 right-0 w-full h-full flex justify-center items-center filter blur-lg" >
                                        ...
                                        <div className=" rounded-lg border border-solid border-gray-200 bg-white overflow-hidden p-2 hover:opacity-80" onClick={() => handleThumbs(index)} >
                                            <Image
                                                src={thumbnail.src}
                                                alt="product thumbnail"
                                                // style={btn_img}
                ...
                <div className="hidden lg:flex lg:justify-between lg:gap-2 lg:items-center mt-4">
                    <div>
                        <ul style={thumbnailsstyle} className="flex flex-wrap gap-2">
                            {thumbsImages2?.map((thumbnail, index) => (
                                <li key={index} className="hover:opacity-50 opacity-100 rounded-lg overflow-hidden  cursor-pointer">
                    ...
                    <div className="text-xs flex items-center gap-2 text-blue-500">
                        <span>۸</span><span>تصویر دیگر</span><span><IoIosArrowBack /></span>
                    </div>
                </div>
            </div>
