    ...
    return (
        <>
            ...
            <div className="container mx-auto w-full p-0 ">
                ...
                <div id="locationInformation" className="relative top-[-190px] lg:top-[-250px] "></div>
                <div id="locationInformation1" className="mt-4"><LocationInformation /></div>
                 
                <div id="featuresConditions" className="relative top-[-190px] "></div>
                <div id="featuresConditions1"><FeaturesConditions /></div>
                <div id="description" className="relative top-[-1000px] lg:top-[-200px] "></div>

                <div id="description1" className="hidden lg:flex"><ProductDescriptions /></div>
                ...
                <div id="questionComment1"><QuestionComment /></div>
                <div id="similarProducts"><SimilarProducts /></div>
                <div id="nearStores"><NearStore /></div>
