    ...
    <div>
      ...
      {showSort && (
        <div className="h-full">
          ...
          <div
            className={`lg:hidden overflow-auto h-[50vh] rounded-lg shadow-lg bottom-0 right-0 left-0 w-full bg-white   fixed  z-40 transition-all ease-in-out duration-3000 ${
