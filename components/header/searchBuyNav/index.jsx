...
const SearchBuyNav = () => {
    ...
    return (
        <div className="flex justify-between py-2 px-4 items-center gap-2 ">
            <div  className=" lg:hidden cursor-pointer text-2xl" onClick={() => dispatch(sidebarChange(sidebarShow))}><AiOutlineMenu/></div>
            <div className="  lg:flex lg:flex-1" ><Logo/></div>
            <div className="  hidden lg:block flex-[5]"><Search/></div>
            <div className=" flex-1"><ProfileControl/></div>
        </div>
    )
}
