...
export default function Layout({ children }) {
  ...
  return (
    <div className="container mx-auto  h-full my-6 ">
      <div className="hidden lg:flex justify-between items-start  gap-4 h-[100%] items-start	">
      ...
      <div className="flex justify-between items-center gap-4 lg:hidden">
        ...
        {
          showItem && (
            <div className="fixed top-0 right-0 bottom-0 left-0 w-full h-full bg-white ">
              <div className="p-4 text-4xl" onClick={() => handleback() }><IoIosArrowForward/></div>
              {children}
            </div>
          )
        }
